...
typedef void  (*WasmInterpEntrySig_6) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_System_Private_CoreLib_ComponentActivator_LoadAssembly (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_6)wasm_native_to_interp_ftndescs [6].func) ((int*)&res, (int*)&arg0, (int*)&arg1, (int*)&arg2, wasm_native_to_interp_ftndescs [6].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_7)wasm_native_to_interp_ftndescs [7].func) ((int*)&res, (int*)&arg0, (int*)&arg1, (int*)&arg2, (int*)&arg3, (int*)&arg4, (int*)&arg5, wasm_native_to_interp_ftndescs [7].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_8) (int*,int*,int*,int*,int*,int*,int*,int*);
...
int res;
((WasmInterpEntrySig_8)wasm_native_to_interp_ftndescs [8].func) ((int*)&res, (int*)&arg0, (int*)&arg1, (int*)&arg2, (int*)&arg3, (int*)&arg4, (int*)&arg5, wasm_native_to_interp_ftndescs [8].arg);
return res;
}
